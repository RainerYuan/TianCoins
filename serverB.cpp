...
#define filePath "block2.txt"
#define updBport "22296" //last 3 digit
...
int reqHandler(char* message){
    ...
    if(args[0] == "c"){
        ...
        output<<args[1]<<endl;
        output.close();
        snprintf(message,buffSize,"new entry successfully saved in B");
    }else if(args[0] == "l"){
        //records needed
...
int main(){
    ...
    cout<<"The ServerB is up and running using UDP on port "<<updBport<<".\n";
    char buffer[buffSize];
    while(true){
